import { getVehicleMetrics } from "@/lib/db/queries/vehicle";
import CostBreakDown from "./CostBreakDown";
import KeyStats from "./KeyStats";
import UpcomingServices from "./UpcomingServices";
import RecentActivity from "./RecentActivity";
import { VehicleMetric, VehicleRecentActivity } from "@/lib/validation/types";
...
export default async function Overview({vehicle_id}:
    ...
    const [metrics, recentActivity, mostRecentService, upcomingService] = await Promise.all([
